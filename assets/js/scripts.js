$(document).ready(() =>{
  const cardAltText = {
    ...
    1: `Image shows an ordered list of 3 items with gibberish cursive after each number, with the following text, Describe your project in three words.`,
    ...
    5: `Image shows a standard orb light bulb with the filament prominently visible like an edison bulb, with the following text, Complete this sentence about your project: "I have discovered that...`,
    ...
    8: `Image shows a looping line/arrow, that begins from the left and gets progressively larger as the curlicue moves right, with the following text, Complete this sentence about your style: "I like giving your feedback and support that is..."`,
